...
<div className="mapsMap"> <div className='mainMap'><iframe frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0" src="https://maps.google.com/maps?width=900&amp;height=400&amp;hl=en&amp;q=Lagos,%20Nigeria+(jacobShevy)&amp;t=p&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div> </div>
                ...
                <div className="details">
                    ...
                    <h2 onMouseEnter={textEnter} onMouseLeave={textLeave}>
                        <a href="http://www.google.com/search?q=lagos&oq=lagos&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQABiPAjIHCAIQABiPAtIBCDY0NTNqMGoxqAIAsAIA&sourceid=chrome&ie=UTF-8" target="_blank" rel="noopener noreferrer">
                            Stoke-on-trent, <br /> United Kingdom
                        </a>
                    </h2>
                </div>
            </div>
