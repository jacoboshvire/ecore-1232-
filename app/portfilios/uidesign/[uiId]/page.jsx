...
import "../../softwaredev/[softId]/software.css"
import "../../../page.css"
...
import Uidesign from '../../../portifilio/@Uidesign/page'
...
export default function Uidesignid({ params }) {
    ...
    async function uidesignPost() {
        let url = `https://jacob-shevy-api.onrender.com/api/uidesign/${uiId}`
    ...
    useEffect(() => {
        uidesignPost().then((data) => {
            setUidesigns(data.foundUidesign)

            setNewtools(data.foundUidesign.tools)
            ...
            setWriteUp(data.foundUidesign.description.replace(/[\t]/g, "&nbsp;" + "&nbsp;" + "&nbsp; ")
                .replace(/[\n]/g, " &nbsp; <br /> &nbsp;")
    ...
    let dates = new Date(uidesigns.date);
    let dateMDY = `${dates.getDate()} - ${dates.getMonth() + 1} - ${dates.getFullYear()}`;
    console.log(uidesigns)
                            ...
                            <div className="softwareLinks">
                                <div className="listPath">
                                    ...
                                    <div className="linkInSoftware" >
                                        ...
                                        <span>&ensp;|&ensp;</span>
                                        <Link href={"#"} className='Mainpage'>{uidesigns.name}</Link>
                                    </div>
                            ...
                            >
                                {
                                    !uidesigns.image ? "" :
                                        <Image
                                            src={uidesigns.image}
                                            alt={uidesigns.name}
                                            height={uidesigns.imageheight}
                                            width={uidesigns.imagewidth}
                                        />
                                }
                            </motion.div>
