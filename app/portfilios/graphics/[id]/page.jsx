...
import Graphics from '../../../portifilio/@Graphics/page'
...
export default function Graphicsid({ params }) {
    ...
    var [writeUp, setWriteUp] = useState([]);
    ...
    useEffect(() => {
        ...
        portfiliopost().then((data) => {
            ...
            setNewtools(data.foundgraphics.tools);
            ...
            setWriteUp(data.foundgraphics.description.replace(/[\t]/g, "&nbsp;" + "&nbsp;" + "&nbsp; ")
                .replace(/[\n]/g, " &nbsp; <br /> &nbsp;")
            ...
            <div className="softwareLinks2">
                <div className="listPath">
                    ...
                    <div className="linkInSoftware" >
                        ...
                        <span>&ensp;|&ensp;</span>
                        <Link href={"#"} className='Mainpage'>{graphic.name}</Link>
                    </div>
